...
export class SettingsPage {
  ...
  async changeProfilePhoto() {
    ...
    if (this.platform.is('cordova')) {
      imageDataResult = await getPicture(this.camera, this.actionSheetCtrl, UserCameraOptions(this.camera));
    } else {
    ...
    if (imageDataResult) {
      ...
      image.imageDataUrl = 'data:image/jpeg;base64,' + imageDataResult;
