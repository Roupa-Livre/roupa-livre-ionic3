...
export class SettingsPage {
  ...
  reloadUser() {
    this.user = Object.assign(new User, this.loginService.user());
  }
  ...
  async changeProfilePhoto() {
    ...
    if (results && results.length > 0) {
      ...
      delete this.user['_destroy'];
      delete this.user['file_url'];
      this.user.data = processedImages[0].compressedImage.imageDataUrl;
      this.saveUser();
    }
  }
